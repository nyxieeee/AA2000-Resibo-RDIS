import { TrendingUp, TrendingDown, DollarSign, FileText, Minus } from 'lucide-react';
...
export function MemberDashboard() {
  ...
  const chartData = useMemo(() => {
    ...
    for (let i = 13; i >= 0; i--) {
      ...
      const dayDocs = filteredDocs.filter(doc => doc.date === prefix);
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <KpiCard title="Total Documents" amount={String(stats.totalDocs)} trend="Successfully processed" positive={true} type="neutral" isCount />
      </div>
